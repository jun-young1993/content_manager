...
export default function VideoViewer(props:any) {
    ...
    console.log(`http://localhost:11101/play/proxy/${contentId}`);
    // const url = `http://localhost:11101/play/proxy/${contentId}`;
    // const test = `https://test-videos.co.uk/vids/bigbuckbunny/mp4/h264/360/Big_Buck_Bunny_360_10s_1MB.mp4`;
    // const test = `http://localhost:11101/play/proxy/${contentId}`;
